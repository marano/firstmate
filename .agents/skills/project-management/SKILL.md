...
Apply `secondmate-provisioning`'s "Routing work to a secondmate" rules; if an existing scope owns that domain, route the new-project operation or work there instead of creating or registering a duplicate main-home clone.
