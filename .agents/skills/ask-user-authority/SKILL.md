...
A decision binds to the run and findings its decision key names; the same finding raised again in a rerun is a new ask-user finding and gets its own decision from firstmate.
