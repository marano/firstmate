...
| `/ask`             | Present your open decisions through the interactive question picker instead of plain text, one at a time, most impactful first - an opt-in that finishes all other fleet work first and refuses while you are away, because the picker pauses supervision until you answer |
