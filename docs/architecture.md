...
The moment that holder is gone while the turn is still over, the same condition surfaces at once instead of on any cadence, because from then on a finished result is sitting unobserved and the cost of the condition is the time it spends uncollected.
