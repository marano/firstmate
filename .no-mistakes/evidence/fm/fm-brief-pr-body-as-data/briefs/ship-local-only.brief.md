...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/var/folders/2w/nqnvq2996wj9df32v4ldywtw0000gn/T//fm-brief-live.JaqJTr/state/ship-local-only.status'`
...
Firstmate steers you through durable message files in '/var/folders/2w/nqnvq2996wj9df32v4ldywtw0000gn/T//fm-brief-live.JaqJTr/state/ship-local-only.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/var/folders/2w/nqnvq2996wj9df32v4ldywtw0000gn/T//fm-brief-live.JaqJTr/state/ship-local-only.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/var/folders/2w/nqnvq2996wj9df32v4ldywtw0000gn/T//fm-brief-live.JaqJTr/state/ship-local-only.inbox'/NNN.msg '/var/folders/2w/nqnvq2996wj9df32v4ldywtw0000gn/T//fm-brief-live.JaqJTr/state/ship-local-only.inbox'/handled/`.
