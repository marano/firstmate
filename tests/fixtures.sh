...
# Creates <dir>/fakebin with the spawn tmux stub, a no-op treehouse, the
# bare-name harness commands (fm_fake_harness_clis), and any extra exit-0 tools.
# Echoes the fakebin path.
