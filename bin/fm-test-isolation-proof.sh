...
exclusion_reason() {
  case "$1" in
    ...
    fm-wake-queue.test.sh|fm-watch-checkpoint.test.sh|fm-watch-triage-absorb.test.sh|fm-watch-triage-stale.test.sh|fm-watch-triage-declared.test.sh|fm-watch-triage-busy.test.sh|\
